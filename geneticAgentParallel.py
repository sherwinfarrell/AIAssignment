...
#This script will begin generating and training generations of snakes from the very beginning. It will overwrite the data of previous generations,
#so make sure to back that up if you are running a new configuration.
